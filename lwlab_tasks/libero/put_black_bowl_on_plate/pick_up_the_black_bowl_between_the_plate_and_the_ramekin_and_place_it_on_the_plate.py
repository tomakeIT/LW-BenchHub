...
class LSPickUpTheBlackBowlBetweenThePlateAndTheRamekinAndPlaceItOnThePlate(PutBlackBowlOnPlate):

    task_name: str = 'LSPickUpTheBlackBowlBetweenThePlateAndTheRamekinAndPlaceItOnThePlate'
