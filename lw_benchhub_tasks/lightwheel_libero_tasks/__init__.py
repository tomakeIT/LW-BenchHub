...
gym.register(
    ...
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={"env_cfg_entry_point": f"{__name__}.turn_on_stove:L90K3TurnOnTheStove"},
)

gym.register(
    id="Robocasa-Task-L90K9TurnOnTheStove",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={"env_cfg_entry_point": f"{__name__}.turn_on_stove:L90K9TurnOnTheStove"},
)

gym.register(
    id="Robocasa-Task-L90K3TurnOnTheStoveAndPutTheFryingPanOnIt",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={"env_cfg_entry_point": f"{__name__}.turn_on_stove:L90K3TurnOnTheStoveAndPutTheFryingPanOnIt"},
)

gym.register(
    id="Robocasa-Task-L90K9TurnOnTheStoveAndPutTheFryingPanOnIt",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={"env_cfg_entry_point": f"{__name__}.turn_on_stove:L90K9TurnOnTheStoveAndPutTheFryingPanOnIt"},
)
...
gym.register(
    ...
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={"env_cfg_entry_point": f"{__name__}.turn_on_stove:L10K3TurnOnTheStoveAndPutTheMokaPotOnIt"},
)
